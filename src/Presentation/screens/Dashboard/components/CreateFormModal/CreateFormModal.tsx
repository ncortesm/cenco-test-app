...
import { Form as FormModel } from 'Data/Repository/Models/Form';
...
interface FormSelectorModal {
    ...
    modalOpen: boolean;
    formSelected: FormModel | undefined;
    formNameSelected: string | undefined;
}
...
const FormSelectorModal = ({
    ...
    const yupSchema = formSelected?.form.reduce(createYupSchema, {});
        ...
        <Modal
            ...
            <Box sx={ModalBoxStyle}>
                ...
                <LocalizationProvider dateAdapter={AdapterDateFns} adapterLocale={es}>
                    <Formik
                        initialValues={extractInitialValues(formSelected!.form)}
                        ...
                        {({
                            ...
                            <Form>
                                <Box mt={'10%'} mb={'15%'}>
                                    {formSelected?.form.map((item, index) => {
